...
class StudentCreateTests(TestCase):
    @patch("apps.school_example.services.students.school_list_school_courses")
    ...
    def test_student_is_rostered_to_all_active_school_courses(
        ...
        school_courses_mock.select_related.return_value = (
            SchoolCourseFactory.stub_batch(size=5)
        )
