...
class SchoolsListCreateApi(APIView):
    ...
    @extend_schema(
        ...
        responses={status.HTTP_201_CREATED: SchoolBaseOutputSerializer},
    )
    def post(self, request: Request) -> Response:
        ...
        return Response(
            data=SchoolBaseOutputSerializer(school).data,
...
class SchoolDetailDeleteApi(APIView):
    @extend_schema(
        ...
        responses={
            status.HTTP_201_CREATED: SchoolBaseOutputSerializer,
